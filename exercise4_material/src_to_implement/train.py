...
trainer = Trainer(model=model_instance, crit=loss_criterion, optim=optimizer, train_dl=train_loader, val_test_dl=val_loader, cuda=t.cuda.is_available(), early_stopping_patience=10)
